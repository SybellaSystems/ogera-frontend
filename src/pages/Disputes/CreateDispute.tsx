...
const CreateDispute: React.FC = () => {
  ...
  return (
    <div className="create-page w-full max-w-full space-y-6 animate-fadeIn">
      <div>
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 md:p-8 create-page-form w-full max-w-full">
