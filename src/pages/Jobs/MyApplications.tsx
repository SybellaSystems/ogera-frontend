    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          style={{
            backgroundColor: isDark ? "#7F56D9" : "#2d1b69",
            color: "#ffffff",
          }}
        >
          Browse Jobs
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        >
          <p className="text-xs font-medium" style={{ color: isDark ? "#c084fc" : "#6941C6" }}>
            Total Applications
          </p>
        ...
        >
          <p className="text-xs font-medium" style={{ color: isDark ? "#fbbf24" : "#c2410c" }}>
            Pending Review
          </p>
          <p className="text-2xl font-bold mt-1" style={{ color: isDark ? "#f3f4f6" : "#9a3412" }}>
            {pendingCount}
          </p>
        </div>
        <div
        ...
        >
          <p className="text-xs font-medium" style={{ color: isDark ? "#34d399" : "#15803d" }}>
            Accepted
          </p>
            ...
            style={{
              backgroundColor:
                statusFilter === tab.key
                  ...
                  : isDark ? "rgba(45, 27, 105, 0.25)" : "#f3f4f6",
      ...
      {filteredApplications.length === 0 ? (
        ...
        >
          ...
          <p className="text-xs mt-1" style={{ color: isDark ? "#9ca3af" : "#6b7280" }}>
            {statusFilter === "all" ? "Start browsing jobs to apply!" : "Try a different filter."}
          </p>
          {statusFilter === "all" && (
            <button
              onClick={() => navigate("/dashboard/jobs/all")}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
          {filteredApplications.map((application) => (
            <article
              ...
              aria-label={`Application for ${application.job?.job_title || "Unknown Job"} - Status: ${application.status}`}
              ...
              <div className="flex items-start justify-between">
                  ...
                  <div className="space-y-1.5" style={{ marginLeft: "52px" }}>
                    ...
                    {application.cover_letter && (
                      ...
                      >
                        ...
                        <p className="line-clamp-2" style={{ color: isDark ? "#9ca3af" : "#6b7280" }}>
                          {application.cover_letter}
                        </p>
                      </div>
                    )}
                ...
                <div className="flex flex-col items-end gap-2 ml-3 flex-shrink-0">
                  ...
                  {application.status === "Pending" && (
                    <button
                      onClick={(e) =>
                        handleWithdraw(application.application_id, application.job?.job_title || "this job", e)
                      }
                      disabled={isWithdrawing && withdrawingId === application.application_id}
                      aria-label={`Withdraw application for ${application.job?.job_title || "this job"}`}
