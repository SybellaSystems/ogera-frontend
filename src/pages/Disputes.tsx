...
const Disputes: React.FC = () => {
  const disputes = [
    { id: 1, type: "Payment", student: "John Doe", employer: "TechCorp", description: "Payment not received for completed work", status: "Open", priority: "High", reportedDate: "2024-03-10" },
    { id: 2, type: "Contract Violation", student: "Emily Smith", employer: "StartupXYZ", description: "Work hours exceeded agreement", status: "Under Review", priority: "Medium", reportedDate: "2024-03-12" },
    { id: 3, type: "Quality Issue", student: "Mike Johnson", employer: "DesignHub", description: "Deliverables quality disputed", status: "Resolved", priority: "Low", reportedDate: "2024-03-05" },
  ];
    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="space-y-4">
        {disputes.map((dispute) => (
          <div key={dispute.id} className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-3 gap-4 mt-3">
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-900">{dispute.student}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500 font-medium">Employer</p>
                    <p className="text-sm font-semibold text-gray-900">{dispute.employer}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500 font-medium">Reported</p>
                    <p className="text-sm font-semibold text-gray-900">{dispute.reportedDate}</p>
                  </div>
                </div>
              </div>
