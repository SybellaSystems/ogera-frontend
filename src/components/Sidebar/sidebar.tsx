      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-700/50 bg-gradient-to-r from-purple-600/10 to-indigo-600/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-white font-bold text-lg bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent">Ogera</h2>
              <p className="text-xs text-purple-300/70 uppercase font-medium">{role}</p>
            </div>
          </div>
        ...
        <nav className="flex-1 p-4 space-y-2">
            ...
            <div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium group-hover:text-white transition-colors">User</span>
                </div>
                <ChevronDownIcon
              ...
              {openMenu === "users" && (
                <ul className="pl-11 space-y-1 text-sm mt-2 animate-fadeIn">
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">All Users</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                    onClick={() =>
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Students</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                    onClick={() =>
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Employers</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Pending Approval</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                    onClick={() =>
            ...
            <div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium group-hover:text-white transition-colors">Academic Verification</span>
                </div>
                <ChevronDownIcon
                  className={`h-4 w-4 transition-transform duration-200 text-gray-400 group-hover:text-white ${
              ...
              {openMenu === "academic" && (
                <ul className="pl-11 space-y-1 text-sm mt-2 animate-fadeIn">
                  ...
                  >
                    <ClockIcon className="h-4 w-4 text-gray-500 group-hover/item:text-purple-400 transition-colors" />
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Pending Reviews</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                    onClick={() =>
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Approved</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                    onClick={() =>
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Rejected</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                    onClick={() =>
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Performance Track</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                    onClick={() =>
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Account Locks</span>
                  </li>
                </ul>
              )}
            </div>
              ...
              {openMenu === "jobs" && (
                <ul className="pl-11 space-y-1 text-sm mt-2 animate-fadeIn">
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">All Jobs</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Active Jobs</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                    onClick={() =>
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Completed</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Job Categories</span>
                  </li>
                </ul>
              )}
            </div>
            ...
            <div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium group-hover:text-white transition-colors">Disputes</span>
                </div>
                <ChevronDownIcon
                  className={`h-4 w-4 transition-transform duration-200 text-gray-400 group-hover:text-white ${
                    openMenu === "disputes" ? "rotate-180 text-purple-400" : ""
                  }`}
                />
              </div>
              ...
              {openMenu === "disputes" && (
                <ul className="pl-11 space-y-1 text-sm mt-2 animate-fadeIn">
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Open Disputes</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                    onClick={() =>
                  ...
                  >
                    ...
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">In Progress</span>
                  </li>
                  <li
                    className="flex items-center gap-2 hover:text-purple-300 cursor-pointer py-2 px-2 rounded-md hover:bg-slate-700/50 transition-all duration-200 group/item"
                    onClick={() =>
                  ...
                  >
                    <CheckCircleIcon className="h-4 w-4 text-gray-500 group-hover/item:text-green-400 transition-colors" />
                    <span className="text-gray-400 group-hover/item:text-white transition-colors">Resolved</span>
                  </li>
                </ul>
              )}
            </div>
          ...
          {(role === "employer" ||
            ...
            >
              ...
              <span className="font-medium group-hover:text-white transition-colors">Analytics</span>
            </div>
          )}
          ...
          {(role === "employer" ||
            ...
            >
              ...
              <span className="font-medium group-hover:text-white transition-colors">Transaction</span>
            </div>
          )}
        </nav>
      </div>
