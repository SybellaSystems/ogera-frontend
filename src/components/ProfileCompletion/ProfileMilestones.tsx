      ...
      <div className="p-4">
        ...
        <div className="relative mb-6">
          ...
          <div className="h-2 bg-gray-200 rounded-full relative">
            <motion.div
              className="absolute inset-y-0 left-0 bg-gradient-to-r from-[#7f56d9] to-[#10b981] rounded-full"
              initial={{ width: 0 }}
                ...
                >
                  ...
                  <span
                    className={`text-[10px] mt-1 font-medium text-center leading-tight ${
                      earned ? "text-[#7f56d9]" : "text-gray-400"
                    }`}
                  >
                    {milestone.threshold}%
                  </span>
        ...
        <div className="bg-[#f5f3ff] rounded-lg px-3 py-2 border border-[#e0d8f0]">
        ...
        {profileCompletion < 100 && onStartWizard && (
          <button
            ...
            className="mt-3 w-full px-4 py-2 bg-[#7f56d9] hover:bg-[#5b3ba5] text-white rounded-lg text-sm font-medium transition-colors cursor-pointer"
          >
            Complete Now
          </button>
        )}
        ...
        <div className="flex items-center justify-between mt-3 text-xs text-gray-500">
          ...
          <span className="font-bold text-[#7f56d9]">{profileCompletion}% complete</span>
        </div>
      </div>
    </div>
  );
